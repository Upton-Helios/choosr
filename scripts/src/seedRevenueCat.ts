...
const PROJECT_NAME = "Choosr";

const PRODUCT_IDENTIFIER = "choosr_premium_unlock";
const PLAY_STORE_PRODUCT_IDENTIFIER = "choosr_premium_unlock";

const PRODUCT_DISPLAY_NAME = "Choosr Premium";
const PRODUCT_USER_FACING_TITLE = "Choosr Premium";

const APP_STORE_APP_NAME = "Choosr";
const APP_STORE_BUNDLE_ID = "com.choosr.app";
const PLAY_STORE_APP_NAME = "Choosr";
const PLAY_STORE_PACKAGE_NAME = "com.choosr.app";
...
// Pricing configuration (amount in micros = dollars * 1,000,000)
const PRODUCT_PRICES = [
  { amount_micros: 990000, currency: "USD" }, // $0.99
  { amount_micros: 990000, currency: "EUR" }, // €0.99
];
